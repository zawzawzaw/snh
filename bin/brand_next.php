...
<!--[if gt IE 8]><!--><html lang="en" class="no-js"><!--<![endif]-->
  ...
  <body class="<?php echo $body_class; ?>">
    ...
    <?php include('brand_header_mobile_next.php'); ?>
    
    <div id="page-wrapper">
      <div id="page-wrapper-content">

        <?php include('brand_header_next.php'); ?>
        ...
        <?php include('page_brand_next.php'); ?>
    ...
    <div class="open-chat-container" style="width: 90px; height: 45px; position: fixed;bottom: 20px;right: 15px; z-index: 999999;">
      <a href="javascript:void(0);" id="open-chat" style="background: url('images/icons/livechat-next.svg') no-repeat; width: 100%; height: 100%; display: block;"></a>    
    </div>
...
file_put_contents('brand_next.html', ob_get_contents());
