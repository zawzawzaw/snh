...
<div id="desktop-header-selector" data-value="events.php"></div>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-10 col-xs-12">
        ...
        <div class="index-page-title">
          <h1>Events</h1>
          <p>We provide the perfect venues in the heart of West Perth for your private celebrations and corporate events.</p>
