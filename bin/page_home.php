...
<article id="home-introduction-section">
  <div class="container-fluid has-breakpoint">
    <div class="row">
      <div class="col-md-12">
        <div id="home-introduction-breadcrumb">
    ...
    <div class="row">
      <div class="col-md-5">
        ...
        <div id="home-introduction-mobile-video" class="visible-sm visible-xs">
        ...
        <div id="home-introduction-copy">
          ...
          <div id="home-introduction-title-2">
      ...
      <div class="col-md-7">
        ...
        <div id="home-introduction-video-container" class="visible-md visible-lg">
          <div id="home-introduction-video">
        ...
        <!--
        <div id="home-introduction-image" class="visible-md visible-lg">
...
<article id="home-promotion-section">
  <div class="container-fluid has-breakpoint">
    <div class="row">
      <div class="col-md-12">
        <div id="home-promotion-title">
    ...
    <div class="row">
      <div id="home-promotion-content">
        <div class="col-md-4">
          <div class="home-promotion-content-box">
            <div class="box-title">
    ...
    <div class="row">
      <div class="col-md-12">
        <a href="#" id="home-promotion-view-all" class="arrow-cta">View all offers</a>
      </div>
    </div>
  </div>
</article>
...
<article id="home-moment-section">
  <div class="container-fluid has-breakpoint">
    <div class="row">
      <div class="col-md-4 hidden-xs hidden-sm">
        <div id="home-moment-content">
      ...
      <div class="col-md-7 col-md-offset-1">
        <div id="home-moment-instagram-feed-container">
