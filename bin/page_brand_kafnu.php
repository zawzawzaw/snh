  ...
  <div id="brand-banner" class="default-page-banner">
    ...
    <div class="default-page-banner-image visible-md visible-lg">
      <div class="manic-image-container has-window-height">
        <img src="" data-image-desktop="images_cms/brand_kafnu/brand-banner.jpg">
      </div>
    </div>
    <div class="default-page-banner-mobile-image visible-sm visible-xs">
      <div class="manic-image-container has-window-height" data-vertical-align="center" data-offset-height="-63">
        <img src=""
          data-image-tablet="images_cms/brand_kafnu/brand-banner-tablet.jpg"
          data-image-mobile="images_cms/brand_kafnu/brand-banner-mobile.jpg">
      </div>
    </div>
    ...
    <div class="default-page-banner-text">   
      <div class="banner-text">
        ...
        <h3>Helping entrepreneurs fulfil their dreams.</h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div id="default-introduction-breadcrumb">
          <a href="brand_landing.php">NEXT Hotels</a><i class="fa fa-long-arrow-right" aria-hidden="true"></i><span>Kafnu</span>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div id="brand-page-introduction-copy">
          ...
          <div id="brand-page-introduction-item-container">
            <div class="brand-page-introduction-item">
              <h1>01.</h1>
              <h4>Flexible for you </h4>
              <p>Adaptable spaces to help entrepreneurs fulfil their dreams. </p>
            </div>
            <div class="brand-page-introduction-item">
              <h1>02.</h1>
              <h4>Inspirational </h4>
              <p>One of a kind spaces that compel entrepreneurs to become their best selves. </p>
            </div>
            <div class="brand-page-introduction-item">
              <h1>03.</h1>
              <h4>Master of many  </h4>
              <p>The best parts of an office, hotel, lounge and private club. </p>
            </div>
            <div class="brand-page-introduction-item">
              <h1>04.</h1>
              <h4>Your craft is everything </h4>
              <p>Giving you the environment, tools and community to achieve your vision. </p>
            </div>
          ...
          <div id="brand-all-location-slider-version-02">
            ...
            <div class="brand-location-slider-item">
              ...
              <div class="brand-location-slider-item-copy">
                <h4>Lorem</h4>
                <h2><a href="hotel.php">Lorem ipsum dolor sit amet consectetur</a></h2>
            ...
            <div class="default-promotion-content-box boxlist-item-box">
              ...
              <div class="default-promotion-content-item-copy">
                <div class="default-copy">
                  <h5><a href="javascript:void(0);">Lorem Ipsum Dolor</a></h5>
                  <h4>Kafnu INTER CITY PERTH</h4>
        ...
        <div class="col-md-4">
          ...
          <div class="default-promotion-content-item boxlist-item">
            <div class="default-promotion-content-box boxlist-item-box">
              ...
              <div class="default-promotion-content-item-copy">
                <div class="default-copy">
                  <h5><a href="javascript:void(0);">Consectetur Adipiscing</a></h5>
                  <h4>Kafnu MT GAMBIER</h4>
        ...
        <div class="col-md-4">
          ...
          <div class="default-promotion-content-item boxlist-item">
            ...
            <div class="default-promotion-content-box boxlist-item-box">
              ...
              <div class="default-promotion-content-item-copy">
                <div class="default-copy">
                  <h5><a href="javascript:void(0);">Eiusmod Tempor</a></h5>
                  <h4>Kafnu ADELAIDE</h4>             
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiar.</p>
