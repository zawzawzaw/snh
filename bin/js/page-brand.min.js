...
sagewest.page.Brand.prototype.others=function(){$("body").addClass("preload-start");$(".brand-location-link").on("click",function(e){e.preventDefault();var target=$(event.currentTarget);var id=target.attr("href");$(".active").removeClass("active");$(id).addClass("active");this.update_page_layout()}.bind(this));this.map_initialize();$("#desktop-header-nav ul li a").on("click",function(e){e.preventDefault();var div=$(this).attr("href").substring(1);$("html, body").animate({scrollTop:$('*[data-value="'+
div+'"]').offset().top},800)});$(".tnc").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").addClass("hover")});$(".back-to-offer").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").removeClass("hover")});function myScroller(){var scrollPos=$(window).scrollTop();if(scrollPos!=0){$("#desktop-menu-bar").removeClass("open");$("body").addClass("scrolled");if(scrolled==false&&initialLoad==false)scrolled=true}else if(scrollPos===0){scrolled=false;$("#desktop-menu-bar").addClass("open");
