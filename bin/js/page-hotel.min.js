...
sagewest.component.MobileHeader=function(options,element){goog.events.EventTarget.call(this);this.options=$.extend({},sagewest.component.MobileHeader.DEFAULT,options);this.element=element;this.body=$("body");this.body_element=$("body");this.window_scroll=0;this.window=$(window);this.window.scroll(this.on_window_scroll.bind(this));this.on_window_scroll(null);this.is_open=false;this.expand_container=$("#mobile-header-expanded");this.page_wrapper=$("#page-wrapper");this.open_btn=this.element.find("#mobile-header-open-btn");
this.close_btn=this.element.find("#mobile-header-close-btn");this.menu_container_element=this.expand_container.find("#mobile-header-menu-container");this.menu_element=this.expand_container.find("#mobile-menu");this.menu_li_elements=null;this.menu_a_elements=null;this.menu_a_array=[];this.create_main_buttons();this.create_menu();console.log("init")};goog.inherits(sagewest.component.MobileHeader,goog.events.EventTarget);sagewest.component.MobileHeader.DEFAULT={"option_01":"","option_02":""};
sagewest.component.MobileHeader.ON_OPEN="on_open";sagewest.component.MobileHeader.ON_CLOSE="on_close";sagewest.component.MobileHeader.prototype.create_main_buttons=function(){this.open_btn.click(this.on_open_btn_click.bind(this));this.close_btn.click(this.on_close_btn_click.bind(this))};
sagewest.component.MobileHeader.prototype.create_menu=function(){this.menu_li_elements=this.menu_element.find("> ul > li");this.menu_a_elements=this.menu_element.find("> ul > li > a");this.menu_a_array=[];var arr=this.menu_element.find("> ul > li > a");var item=null;for(var i=0,l=arr.length;i<l;i++){item=$(arr[i]);item.click(this.on_menu_a_click.bind(this));this.menu_a_array[i]=item}arr=this.menu_element.find("> ul > li .expand-btn");for(var i=0,l=arr.length;i<l;i++){item=$(arr[i]);item.click(this.on_menu_expand_btn_click.bind(this))}};
sagewest.component.MobileHeader.prototype.open_menu=function(){console.log("MobileHeader: open_menu");if(this.is_open==false){this.is_open=true;console.log("MobileHeader: open_menu: inside");this.body.addClass("mobile-menu-open");this.page_wrapper.addClass("hidden-version");this.expand_container.addClass("expand-version");TweenMax.to(this.close_btn,.3,{autoAlpha:1});TweenMax.to(this.open_btn,.3,{autoAlpha:0});this.dispatchEvent(new goog.events.Event(sagewest.component.MobileHeader.ON_OPEN))}};
sagewest.component.MobileHeader.prototype.close_menu=function(){if(this.is_open==true){this.is_open=false;this.body.removeClass("mobile-menu-open");this.page_wrapper.removeClass("hidden-version");this.expand_container.removeClass("expand-version");TweenMax.to(this.close_btn,.3,{autoAlpha:0});TweenMax.to(this.open_btn,.3,{autoAlpha:1});this.menu_li_elements.removeClass("expand-version");this.dispatchEvent(new goog.events.Event(sagewest.component.MobileHeader.ON_CLOSE))}};
sagewest.component.MobileHeader.prototype.on_open_btn_click=function(event){this.open_menu()};sagewest.component.MobileHeader.prototype.on_close_btn_click=function(event){this.close_menu()};
sagewest.component.MobileHeader.prototype.on_menu_a_click=function(event){var target=$(event.currentTarget);var target_parent=target.parent();var is_subnav=target_parent.hasClass("has-subnav");var is_expanded=target_parent.hasClass("expand-version");if(is_subnav)if(is_expanded){if(target.attr("href")=="#"){event["preventDefault"]();target_parent.removeClass("expand-version")}}else{event["preventDefault"]();this.menu_li_elements.removeClass("expand-version");target_parent.addClass("expand-version")}};
sagewest.component.MobileHeader.prototype.on_menu_expand_btn_click=function(event){event["preventDefault"]();var target=$(event.currentTarget);var target_parent=target.parent();var is_expanded=target_parent.hasClass("expand-version");if(is_expanded)this.menu_li_elements.removeClass("expand-version");else{this.menu_li_elements.removeClass("expand-version");target_parent.addClass("expand-version")}};
...
$("#date-picker").daterangepicker({"autoApply":true,"opens":"right","parentEl":"#desktop-header-booking-calendar","minDate":formatted_current_date,"locale":{"separator":" to ","daysOfWeek":["S","M","T","W","T","F","S"],"monthNames":["January","February","March","April","May","June","July","August","September","October","November","December"]}});$("#date-picker").on("apply.daterangepicker",function(ev,picker){$(this).val(picker.startDate.format("MM/DD/YYYY")+" - "+picker.endDate.format("MM/DD/YYYY"))});
...
!$(event.target).closest("th, td, tr").length&&!$(event.target).closest("select").length&&!$(event.target).closest("input").length&&!$(event.target).closest(".date-input").length)if($("#desktop-header-booking-form").is(":visible"))$("#desktop-header-booking-form").slideUp(300)})};
...
sagewest.page.Hotel.prototype.others=function(){$("body").addClass("preload-start");$("#hotel-reviews-slider").slick({dots:false,infinite:true,slidesToShow:1,prevArrow:'<a class="carousel-prev"><span></span></a>',nextArrow:'<a class="carousel-next"><span></span></a>'});this.map_initialize();$(".tnc").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").addClass("hover")});$(".back-to-offer").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").removeClass("hover")});
function myScroller(){var scrollPos=$(window).scrollTop();console.log(scrollPos);if(scrollPos>=467){$("#desktop-menu-bar").removeClass("open");$("body").addClass("scrolled");if(scrolled==false&&initialLoad==false)scrolled=true}else if(scrollPos<=467){scrolled=false;$("#desktop-menu-bar").addClass("open");$("body").removeClass("scrolled")}}var initialLoad=true;var scrolled=false;$(window).on("scroll",function(){myScroller()});myScroller()};
