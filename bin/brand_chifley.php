...
<!--[if gt IE 8]><!--><html lang="en" class="no-js"><!--<![endif]-->
  ...
  <body class="<?php echo $body_class; ?>">
    ...
    <?php include('brand_header_mobile_chifley.php'); ?>
    
    <div id="page-wrapper">
      <div id="page-wrapper-content">

        <?php include('brand_header_chifley.php'); ?>
        ...
        <?php include('page_brand_chifley.php'); ?>
        ...
        <?php include('js_brand_chifley.php'); ?>
    ...
    <div class="open-chat-container" style="width: 90px; height: 45px; position: fixed;bottom: 20px;right: 15px; z-index: 999999;">
      <a href="javascript:void(0);" id="open-chat" style="background: url('images/icons/livechat-chifley.svg') no-repeat; width: 100%; height: 100%; display: block;"></a>    
    </div>
...
file_put_contents('brand_chifley.html', ob_get_contents());
