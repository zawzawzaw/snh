    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-10 col-xs-12">
        ...
        <div class="index-page-title">
          <h1>Simply Irresistable Deals</h1>
          <p>We have all the best hotel deals in West Perth –  making your time count. <br class="hidden-xs hidden-sm"> Be it a weekend escape with our ‘City Escape’ Package or a romantic Italian dinner for two, Sage West Perth has just the deal for you.</p>
        ...
        <div class="col-md-4 default-promo-box all accomodation">
          ...
          <div class="default-promotion-content-item boxlist-item">
            <div class="default-promotion-content-box boxlist-item-box">
              ...
              <div class="default-promotion-content-item-copy">
                <div class="default-copy">
                  <h5><a href="offer_detail.php">Enjoy Additional 15% off</a></h5>
...
<article id="offer-page-expanding-content-section" class="visible-sm visible-xs">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-12">
            ...
            <div id="offer-index-page-item-container" class="boxlist-item-container mobile-height-version">
              <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                  <div class="offer-index-page-item boxlist-item">
                    ...
                    <div class="offer-index-page-item-box boxlist-item-box">
                      ...
                      <div class="offer-index-page-item-arrow-cta-container-mobile">
                        <a href="offer_detail.php" class="arrow-cta">More Details</a>
                      </div>
