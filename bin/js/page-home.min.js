...
ease:Quad.easeInOut})};goog.exportSymbol("sagewest.page.Default",sagewest.page.Default);goog.provide("sagewest.page.Home");goog.require("sagewest.page.Default");goog.require("manic.google.Map");sagewest.page.Home=function(options,element){sagewest.page.Default.call(this,options,element);this.options=$.extend(this.options,sagewest.page.Home.DEFAULT,options);this.map=null;this.experience_carousel=null;this.contact_map=null};goog.inherits(sagewest.page.Home,sagewest.page.Default);sagewest.page.Home.DEFAULT={};
sagewest.page.Home.prototype.init=function(){sagewest.page.Home.superClass_.init.call(this);this.create_experience_slider();this.create_contact_map();this.others();this.update_page_layout()};sagewest.page.Home.prototype.create_experience_slider=function(){this.experience_carousel=$("#home-experience-carousel").slick({"speed":350,"dots":false,"arrows":false,"infinite":false,"slidesToShow":1,"slidesToScroll":1,"pauseOnHover":true,"autoplay":true,"autoplaySpeed":4E3})};
sagewest.page.Home.prototype.create_contact_map=function(){};
sagewest.page.Home.prototype.create_instagram=function(){this.instagram_feed=null;var instafeed_template=['<a class="home-instagram-item" href="{{link}}" target="_blank" title="{{caption}}">','<div class="manic-image-container">','<img src="" data-image-desktop="{{image}}">',"</div>","</a>"].join("");this.instagram_feed=new Instafeed({"target":"home-instagram-item-container","get":"user","userId":2989036714,"accessToken":"2989036714.1677ed0.7bf2fb6621874f7fbd244ce3ccf92749","template":instafeed_template,
"before":this.on_before_instafeed_create_html.bind(this),"after":this.on_after_instafeed_create_html.bind(this),"limit":6,"resolution":"low_resolution"});this.instagram_feed.run()};sagewest.page.Home.prototype.on_before_instafeed_create_html=function(){$("#home-instagram-item-container").empty()};
sagewest.page.Home.prototype.on_after_instafeed_create_html=function(){var arr=$("#home-instagram-item-container .manic-image-container");var image_container=null;var item=null;for(var i=0,l=arr.length;i<l;i++){item=$(arr[i]);image_container=new manic.ui.ImageContainer({"has_window_resize":false,"scale_mode":"best_fit_no_scale_down"},item);this.manic_image_array[this.manic_image_array.length]=image_container}this.update_page_layout()};
sagewest.page.Home.prototype.update_page_layout=function(){sagewest.page.Home.superClass_.update_page_layout.call(this);this.window_width=this.window.width();this.window_height=this.window.height();if(this.window_width<=1280&&manic.IS_ACTUAL_MOBILE==false||manic.IS_ACTUAL_MOBILE==true&&manic.IS_TABLET_LANDSCAPE){this.window_width*=1.1111;this.window_height*=1.1111}};
sagewest.page.Home.prototype.scroll_to_target=function(str_param,str_param_2,str_param_3){sagewest.page.Home.superClass_.scroll_to_target.call(this,str_param)};sagewest.page.Home.prototype.on_scroll_to_no_target=function(){};
sagewest.page.Home.prototype.others=function(){$("body").addClass("preload-start");$("#home-location-content-carousel").slick({dots:true,centerMode:true,centerPadding:"155px",slidesToShow:1,prevArrow:'<a class="carousel-prev"><span></span></a>',nextArrow:'<a class="carousel-next"><span></span></a>',responsive:[{breakpoint:768,settings:{arrows:false,centerMode:true,centerPadding:"40px",slidesToShow:3}},{breakpoint:480,settings:{arrows:false,centerMode:true,centerPadding:"40px",slidesToShow:1}}]});
$("#home-location-content-mobile-carousel").slick({dots:true,slidesToShow:1,prevArrow:'<a class="carousel-prev"><span></span></a>',nextArrow:'<a class="carousel-next"><span></span></a>',responsive:[{breakpoint:480,settings:{arrows:false,slidesToShow:1}}]});$("#home-location-content-carousel").on("beforeChange",function(event,slick,currentSlide,nextSlide){$(".home-location-content-carousel-text").removeClass("active");var nextSlide=nextSlide+1;console.log(nextSlide);$("#home-location-content-carousel-text-"+
nextSlide).addClass("active")});this.map_initialize();$("#desktop-header-nav ul li a").on("click",function(e){e.preventDefault();var div=$(this).attr("href").substring(1);$("html, body").animate({scrollTop:$('*[data-value="'+div+'"]').offset().top},800)});$(".tnc").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").addClass("hover")});$(".back-to-offer").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").removeClass("hover")});function myScroller(){var scrollPos=
$(window).scrollTop();if(scrollPos!=0){$("#desktop-menu-bar").removeClass("open");$("body").addClass("scrolled");if(scrolled==false&&initialLoad==false)scrolled=true}else if(scrollPos===0){scrolled=false;$("#desktop-menu-bar").addClass("open");$("body").removeClass("scrolled")}}var initialLoad=true;var scrolled=false;$(window).on("scroll",function(){myScroller()});myScroller()};
sagewest.page.Home.prototype.map_initialize=function(){var map;var styles=[{"featureType":"administrative","elementType":"labels.text.fill","stylers":[{"color":"#6195a0"}]},{"featureType":"landscape","elementType":"all","stylers":[{"color":"#f2f2f2"}]},{"featureType":"landscape","elementType":"geometry.fill","stylers":[{"color":"#ffffff"}]},{"featureType":"poi","elementType":"all","stylers":[{"visibility":"off"}]},{"featureType":"poi.park","elementType":"geometry.fill","stylers":[{"color":"#e6f3d6"},
...
google.maps.event.addDomListener(window,"resize",function(){var center=map.getCenter();google.maps.event.trigger(map,"resize");map.setCenter(center)})};goog.exportSymbol("sagewest.page.Home",sagewest.page.Home);
