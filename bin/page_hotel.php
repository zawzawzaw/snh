...
/_/  |_\____/\____/\____/_/  /_/_/  /_/\____/_____/_/  |_/_/ /___/\____/_/ |_/
...
<article id="hotel-accommodation-section">
  <div class="container-fluid has-breakpoint">
    ...
    <div class="row">
      <div class="col-md-12">
        <a href="#" id="hotel-accommodation-view-all" class="arrow-cta">View all</a>
      </div>
    </div>
  </div>
</article>
...
<article id="hotel-attraction-section">
  ...
  <div class="container-fluid has-breakpoint">
    <div class="row">
      <div id="hotel-attraction-content">
        <div class="col-md-4 hidden-sm hidden-xs">
          <div class="hotel-attraction-content-box">
            <div class="box-title">
