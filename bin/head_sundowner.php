...
<link rel="icon" href="images/icons/favicon-sundowner.png">

<!-- Critical Css -->
<link rel="stylesheet" type="text/css" href="css/critical_style_sundowner.css">
...
<?php if($is_debug): ?>
  ...
  <!-- <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300italic,400,400italic,600,700|Playfair+Display:400,600|Poppins:300,400,500|Lato:300,400,600|Allan" rel="stylesheet"> -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300italic,400,400italic,600,700|Lato:300,400,600|Allan" rel="stylesheet">
...
<script>
  $zopim(function() {
    ...
    $zopim.livechat.theme.setColor('#fdb924');
