...
<div id="desktop-header-selector" data-value="facilities.php"></div>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-10 col-xs-12">
        ...
        <div class="index-page-title">
          <h1>Facilities</h1>
          <p>Whether you are looking for somewhere to chill, taking a dip in the pool or having a workout, Sage West Perth offers them all within its vicinity.</p>
                  ...
                  <div class="default-copy">
                    ...
                    <div class="more-details">
                      <ul>
                        ...
                        <li>Wireless, secure printer</li>
                        <li>Comfy couches to sit and watch TV</li>
                        <li>Boardroom table for meetings</li>
                        <li>Library with books featuring human achievement and design</li>
                      </ul>
    ...
    <div class="detail-list-item-mobile first-version">
      ...
      <div class="detail-list-item-expanding-container">
        ...
        <div class="manic-expand-container" data-group="mobile-facilities-landing">
          <div class="scroll-target" data-value="mobile-facilities-01"></div>
          <div class="manic-expand-container-title">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-1 col-xs-0"></div>
