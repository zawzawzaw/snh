...
<div id="page-wrapper-content-min-height">
      ...
      <div class="container-fluid has-breakpoint">
        <div class="row">
          <div class="col-md-9">
            ...
            <div id="brand-location-page-title">
              <h1>Explore Country Comfort in Australia</h1>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <!-- selected by default if there are no hashtags -->
            <div id="brand-location-page-filter-container" data-selected-country="Australia" data-selected-territory="New South Wales" data-selected-city="">
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="manic-dropdown not-selected-version" id="brand-location-country-dropdown">
                ...
                <div class="col-md-3">
                  ...
                  <div class="manic-dropdown not-selected-version" id="brand-location-territory-dropdown">
                ...
                <div class="col-md-3">
                  ...
                  <div class="manic-dropdown not-selected-version" id="brand-location-city-dropdown">
  ...
  <!--
     __  __  ___  ____ ___ _     _____   ____    _    _   _ _   _ _____ ____
    |  \/  |/ _ \| __ )_ _| |   | ____| | __ )  / \  | \ | | \ | | ____|  _ \
    | |\/| | | | |  _ \| || |   |  _|   |  _ \ / _ \ |  \| |  \| |  _| | |_) |
    | |  | | |_| | |_) | || |___| |___  | |_) / ___ \| |\  | |\  | |___|  _ <
    |_|  |_|\___/|____/___|_____|_____| |____/_/   \_\_| \_|_| \_|_____|_| \_\

  -->

  <!-- 
  <div class="scroll-target" data-value="banner"></div>
  <article id="brand-banner-section" class="visible-sm visible-xs">
  ...
  <article id="brand-all-location-section" class="visible-sm visible-xs">
    ...
    <div id="brand-all-location-content-box">
      ...
      <div class="territory-expanding-container" data-value="mobile-new-south-wales" data-hash-value="australia-new-south-wales">
        <div class="scroll-target" data-value="mobile-new-south-wales"></div>
        <div class="territory-title-bar"><h4>New South Wales</h4></div>
        <div class="territory-expanded-content">
          ...
          <div class="sub-title-bar"><h4>Casula</h4></div>
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6 col-xs-12">
          ...
          <div class="sub-title-bar"><h4>Heatherbrae</h4></div>
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6 col-xs-12">
      ...
      <div class="territory-expanding-container" data-value="mobile-queensland" data-hash-value="australia-queensland">
        <div class="scroll-target" data-value="mobile-queensland"></div>
        <div class="territory-title-bar"><h4>Queensland</h4></div>
        <div class="territory-expanded-content">
          ...
          <div class="sub-title-bar"><h4>Highfields</h4></div>
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6 col-xs-12">
