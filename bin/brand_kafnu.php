  ...
  <body class="<?php echo $body_class; ?>">
    ...
    <div id="page-preloader">
      <div id="page-preloader-logo">
        <img src="images/icons/preloader-kafnu.png">
      </div>
    ...
    <?php include('brand_header_mobile_kafnu.php'); ?>
    
    <div id="page-wrapper">
      <div id="page-wrapper-content">

        <?php include('brand_header_kafnu.php'); ?>
        ...
        <?php include('page_brand_kafnu.php'); ?>
        ...
        <?php include('js_brand_kafnu.php'); ?>
    ...
    <div class="open-chat-container" style="width: 90px; height: 45px; position: fixed;bottom: 20px;right: 15px; z-index: 999999;">
      <a href="javascript:void(0);" id="open-chat" style="background: url('images/icons/livechat-kafnu.svg') no-repeat; width: 100%; height: 100%; display: block;"></a>    
    </div>
...
file_put_contents('brand_kafnu.html', ob_get_contents());
