...
<article id="brand-introduction-section">
  <div class="container-fluid has-breakpoint">
    <div class="row">
      <div class="col-md-12">
        <div id="brand-introduction-breadcrumb">
    ...
    <div class="row">
      <div class="col-md-5">
        ...
        <div id="brand-introduction-mobile-video" class="visible-sm visible-xs">
        ...
        <div id="brand-introduction-copy">

          <div id="brand-introduction-title">
          ...
          <div id="brand-introduction-title-2">
      ...
      <div class="col-md-7">
        ...
        <div id="brand-introduction-video-container" class="visible-md visible-lg">
          <div id="brand-introduction-video">
        ...
        <!--
        <div id="brand-introduction-image" class="visible-md visible-lg">
...
<article id="brand-promotion-section">
  <div class="container-fluid has-breakpoint">
    ...
    <div class="row">
      <div id="brand-promotion-content">
        <div class="col-md-4">
          <div class="brand-promotion-content-box">
            <div class="box-title">
...
<article id="brand-moment-section">
  <div class="container-fluid has-breakpoint">
    <div class="row">
      <div class="col-md-4 hidden-sm hidden-xs">
        <div id="brand-moment-content">
      ...
      <div class="col-md-7 col-md-offset-1">
        <div id="brand-moment-instagram-feed-container">
...
<article id="brand-map-section">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <div id="brand-map-title">
          <h4>sage hotels</h4>
          <h1>Our locations</h1>
        </div>
      </div>
