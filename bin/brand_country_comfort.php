...
<!--[if gt IE 8]><!--><html lang="en" class="no-js"><!--<![endif]-->
  <head>
    <?php include('head_country_comfort.php'); ?>
  </head>
  ...
  <body class="<?php echo $body_class; ?>">
    ...
    <div id="page-preloader" class="square-version">
      <div id="page-preloader-logo">
        <img src="images/icons/preloader-country-comfort.png">
      </div>
    ...
    <div id="page-wrapper">
      <div id="page-wrapper-content">
        ...
        <?php include('brand_header_country_comfort.php'); ?>
        ...
        <?php include('page_brand_country_comfort.php'); ?>
    ...
    <div class="open-chat-container" style="width: 90px; height: 45px; position: fixed;bottom: 20px;right: 15px; z-index: 999999;">
      <a href="javascript:void(0);" id="open-chat" style="background: url('images/icons/livechat-comfort.svg') no-repeat; width: 100%; height: 100%; display: block;"></a>    
    </div>
...
file_put_contents('brand_country_comfort.html', ob_get_contents());
