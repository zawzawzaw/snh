...
<link rel="icon" href="images/icons/favicon-chifley.png">

<!-- Critical Css -->
<link rel="stylesheet" type="text/css" href="css/critical_style_chifley.css">
...
<?php if($is_debug): ?>
  ...
  <!-- <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300italic,400,400italic,600,700|Playfair+Display:400,600|Poppins:300,400,500|Lato:300,400,600|Julius+Sans+One" rel="stylesheet"> -->
...
<script>
  $zopim(function() {
    ...
    $zopim.livechat.theme.setColor('#e6b00f');
    ...
    $zopim.livechat.concierge.setTitle('Chifley Hotels');

    $zopim.livechat.window.setTitle('CHIFLEY HOTELS');
