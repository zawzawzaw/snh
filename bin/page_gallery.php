...
<div id="page-gallery-data-item-container">
  ...
  <div class="page-gallery-data-item"
    ...
    data-accommodation-cta-url="booking_engine_search.php"
...
<div id="page-wrapper-content-min-height">
  ...
  <div id="desktop-header-selector" data-value="gallery.php"></div>
  ...
  <article id="gallery-page-title-section">
    <div class="container-fluid has-breakpoint">
      <div class="row">
        <div class="col-md-12">

          <div id="gallery-page-title">
            <h1>Gallery</h1>
          </div> <!-- default-index-page-title -->

          <div id="gallery-page-tab-container" class="visible-md visible-lg">
            <nav>
              <ul>
  ...
  <!--
     ___ _   _ ____  _______  __  _____  _    ____
    |_ _| \ | |  _ \| ____\ \/ / |_   _|/ \  | __ )
     | ||  \| | | | |  _|  \  /    | | / _ \ |  _ \
     | || |\  | |_| | |___ /  \    | |/ ___ \| |_) |
    |___|_| \_|____/|_____/_/\_\   |_/_/   \_\____/
  ...
  <!--
     ____  _____ _____  _    ___ _       _____  _    ____
    |  _ \| ____|_   _|/ \  |_ _| |     |_   _|/ \  | __ )
    | | | |  _|   | | / _ \  | || |       | | / _ \ |  _ \
    | |_| | |___  | |/ ___ \ | || |___    | |/ ___ \| |_) |
    |____/|_____| |_/_/   \_\___|_____|   |_/_/   \_\____/

  -->

  <div id="page-gallery-detail-tab">

    <article id="gallery-slider-section">
      <div class="container-fluid has-breakpoint">
        <div class="row">
          <div class="col-md-12">
            ...
            <div id="gallery-slider-container">
              ...
              <div id="gallery-slider">
                ...
                <div class="gallery-slider-item">
                  <div class="manic-image-container">
                    <img src="" 
                      data-image="images_cms/gallery/accommodation-01-large.jpg">
                  </div>
                </div>
            ...
            <!--
               _____ _   _ _   _ __  __ ____  _   _    _    ___ _
              |_   _| | | | | | |  \/  | __ )| \ | |  / \  |_ _| |
                | | | |_| | | | | |\/| |  _ \|  \| | / _ \  | || |
                | | |  _  | |_| | |  | | |_) | |\  |/ ___ \ | || |___
                |_| |_| |_|\___/|_|  |_|____/|_| \_/_/   \_\___|_____|
      ...
      <a href="" id="gallery-close-btn-mobile" class="visible-sm visible-xs"></a>

    </article> <!-- gallery-slider-section -->


    <article id="gallery-slider-cta-section" class="visible-md visible-lg">
      <div class="container-fluid has-breakpoint">
        <div class="row">
          <div class="col-md-12">
