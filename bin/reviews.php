...
<?php 
  ...
  $body_class = "hotel reviews-page permanent-scrolled";

  // page-reviews-index-tab-open is important! don't remove it
  // 
...
file_put_contents('reviews.html', ob_get_contents());
