...
<?php 
  ...
  $body_class = "hotel offer-index-page permanent-scrolled";
?>
<!doctype html>
  ...
  <body class="<?php echo $body_class; ?>">
    ...
    <div id="page-wrapper">
      <div id="page-wrapper-content">
        ...
        <?php include('page_offer_index.php'); ?>
...
file_put_contents('offer_index.html', ob_get_contents());
