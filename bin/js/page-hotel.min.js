...
$("#date-picker").daterangepicker({"autoApply":true,"opens":"right","parentEl":"#desktop-header-booking-calendar","minDate":formatted_current_date,"locale":{"separator":" to ","daysOfWeek":["S","M","T","W","T","F","S"],"monthNames":["January","February","March","April","May","June","July","August","September","October","November","December"]}});$("#mobile-date-picker").daterangepicker({"autoApply":true,"opens":"bottom","parentEl":"#mobile-header-booking-calendar","minDate":formatted_current_date,
"locale":{"separator":" to ","daysOfWeek":["S","M","T","W","T","F","S"],"monthNames":["January","February","March","April","May","June","July","August","September","October","November","December"]}});$("#date-picker").on("apply.daterangepicker",function(ev,picker){$(this).val(picker.startDate.format("MM/DD/YYYY")+" - "+picker.endDate.format("MM/DD/YYYY"))});$(document).click(function(event){if(!$(event.target).closest("#desktop-menu-bar").length&&!$(event.target).closest("#hoverscroll").length)if($("#desktop-header-menu").is(":visible")){$("#desktop-header-menu").slideUp(300);
$("#desktop-header").removeClass("open")}if(!$(event.target).closest("#book-now").length&&!$(event.target).closest("#date-picker").length&&!$(event.target).closest(".next").length&&!$(event.target).closest(".prev").length&&!$(event.target).closest("#hover-day").length&&!$(event.target).closest("#hover-weekname").length&&!$(event.target).closest("th, td, tr").length&&!$(event.target).closest("select").length&&!$(event.target).closest("input").length&&!$(event.target).closest(".date-input").length)if($("#desktop-header-booking-form").is(":visible"))$("#desktop-header-booking-form").slideUp(300)})};
...
sagewest.page.Hotel.prototype.others=function(){$("body").addClass("preload-start");$("#hotel-reviews-slider").slick({dots:false,infinite:true,slidesToShow:1,prevArrow:'<a class="carousel-prev"><span></span></a>',nextArrow:'<a class="carousel-next"><span></span></a>'});$("#hotel-booking-content").slick({slidesToShow:1,responsive:[{breakpoint:4E3,settings:"unslick"},{breakpoint:991,settings:{dots:true,arrows:false,slidesToShow:1,slidesToScroll:1}}]});this.map_initialize();$(".tnc").on("click",function(e){e.preventDefault();
...
sagewest.page.Hotel.prototype.map_initialize=function(){var map;var styles=[{"featureType":"water","elementType":"geometry.fill","stylers":[{"color":"#d3d3d3"}]},{"featureType":"transit","stylers":[{"color":"#808080"},{"visibility":"off"}]},{"featureType":"road.highway","elementType":"geometry.stroke","stylers":[{"visibility":"on"},{"color":"#b3b3b3"}]},{"featureType":"road.highway","elementType":"geometry.fill","stylers":[{"color":"#ffffff"}]},{"featureType":"road.local","elementType":"geometry.fill",
"stylers":[{"visibility":"on"},{"color":"#ffffff"},{"weight":1.8}]},{"featureType":"road.local","elementType":"geometry.stroke","stylers":[{"color":"#d7d7d7"}]},{"featureType":"poi","elementType":"geometry.fill","stylers":[{"visibility":"on"},{"color":"#ebebeb"}]},{"featureType":"administrative","elementType":"geometry","stylers":[{"color":"#a7a7a7"}]},{"featureType":"road.arterial","elementType":"geometry.fill","stylers":[{"color":"#ffffff"}]},{"featureType":"road.arterial","elementType":"geometry.fill",
"stylers":[{"color":"#ffffff"}]},{"featureType":"landscape","elementType":"geometry.fill","stylers":[{"visibility":"on"},{"color":"#efefef"}]},{"featureType":"road","elementType":"labels.text.fill","stylers":[{"color":"#696969"}]},{"featureType":"administrative","elementType":"labels.text.fill","stylers":[{"visibility":"on"},{"color":"#737373"}]},{"featureType":"poi","elementType":"labels.icon","stylers":[{"visibility":"off"}]},{"featureType":"poi","elementType":"labels","stylers":[{"visibility":"off"}]},
{"featureType":"road.arterial","elementType":"geometry.stroke","stylers":[{"color":"#d6d6d6"}]},{"featureType":"road","elementType":"labels.icon","stylers":[{"visibility":"off"}]},{},{"featureType":"poi","elementType":"geometry.fill","stylers":[{"color":"#dadada"}]}];function setMarkerLatLng(lat,lng){return new google.maps.LatLng(lat,lng)}var AusLatLng=setMarkerLatLng(-31.946899,115.8524116);var mapOptions={mapTypeControlOptions:{mapTypeIds:["Styled"]},zoom:15,center:AusLatLng,disableDefaultUI:true,
mapTypeId:"Styled",scrollwheel:false,zoomControl:true};map=new google.maps.Map(document.getElementById("hotel-attraction-map"),mapOptions);var styledMapType=new google.maps.StyledMapType(styles,{name:"Styled"});map.mapTypes.set("Styled",styledMapType);var WestPerthLatlng=setMarkerLatLng(-31.9494288,115.8362825);var OrdStLatlng=setMarkerLatLng(-31.948616,115.835907);var JamesStLatlng=setMarkerLatLng(-31.946899,115.8524116);var FielderStLatlng=setMarkerLatLng(-31.9509356,115.8708259);var SterlingStLatlng=
setMarkerLatLng(-31.9468795,115.8635481);infobox=new InfoBox({disableAutoPan:false,maxWidth:225,zIndex:null,boxStyle:{opacity:1,width:"225px"},infoBoxClearance:new google.maps.Size(1,1)});var markersObj={};function createGoogleMarker(markerName,Latlng,icon,title){markersObj[markerName]=new google.maps.Marker({position:Latlng,map:map,title:title,icon:"images/icons/map-pin-grey.png"})}createGoogleMarker("WestPerthMarker",WestPerthLatlng,"westperth","Sage West Perth");createGoogleMarker("OrdMarker",
OrdStLatlng,"ordst","Ord Street");createGoogleMarker("JamesStreetMarker",JamesStLatlng,"jamesst","James Street");createGoogleMarker("FielderStreetMarker",FielderStLatlng,"fielder","Fielder Street");createGoogleMarker("SterlingStreetMarker",SterlingStLatlng,"sterling","Sterling Street");var WestPerthPlaceId="ChIJufd18zGlMioRIFTfNbXwBAU";var OrdStPlaceId="EihKYW1lcyBTdCwgTm9ydGhicmlkZ2UgV0EgNjAwMywgQXVzdHJhbGlh";var JamesStPlaceId="ChIJe1YLH6UZE2sRIOcyFmh9AQU";var FielderStPlaceId="ChIJ56QDo9fOsGoRUz4cTlhwjbM";
var SterlingStPlaceId="EiVTdGlybGluZyBTdCwgUGVydGggV0EgNjAwMCwgQXVzdHJhbGlh";requestObj={};function createRequestObj(requestObjName,PlaceId){requestObj[requestObjName]={placeId:PlaceId}}createRequestObj("westPerthRequest",WestPerthPlaceId);createRequestObj("OrdStRequest",OrdStPlaceId);createRequestObj("JamesStRequest",JamesStPlaceId);createRequestObj("FielderStRequest",FielderStPlaceId);createRequestObj("SterlingStRequest",SterlingStPlaceId);function events(Marker,MarkerLatLng,MarkerRequest){google.maps.event.addListener(Marker,
"click",function(){infobox.open(map,this);infobox.setContent("<div class='infoBox-text'><div class='address'><div class='address-content'><a target='_blank' href='http://maps.google.com/?q=Sage West Perth 1309 Hay Street, West Perth WA 6005, Australia'><h4>Sage West Perth</h4><p>1309 Hay Street, West Perth WA 6005, Australia</p></a></div></div><div class='arrow-left'></div></div>");infobox.setOptions({"pixelOffset":new google.maps.Size(45,-95)});map.panTo(MarkerLatLng)});google.maps.event.addListener(Marker,
"mouseover",function(){Marker.setIcon("images/icons/map-pin-hover.png")});google.maps.event.addListener(Marker,"mouseout",function(){Marker.setIcon("images/icons/map-pin-grey.png")});google.maps.event.addListener(map,"click",function(event){infobox.close()})}events(markersObj["WestPerthMarker"],WestPerthLatlng,requestObj["westPerth"]);events(markersObj["OrdMarker"],OrdStLatlng,requestObj["OrdStRequest"]);events(markersObj["JamesStreetMarker"],JamesStLatlng,requestObj["JamesStRequest"]);events(markersObj["FielderStreetMarker"],
