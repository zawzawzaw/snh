...
$("#home-location-content-carousel").on("beforeChange",function(event,slick,currentSlide,nextSlide){$(".home-location-content-carousel-text").removeClass("active");var nextSlide=nextSlide+1;console.log(nextSlide);$("#home-location-content-carousel-text-"+nextSlide).addClass("active")});this.map_initialize();$("#desktop-header-nav ul li a").on("click",function(e){e.preventDefault();var div=$(this).attr("href").substring(1);$("html, body").animate({scrollTop:$('*[data-value="'+div+'"]').offset().top},
800)});$(".tnc").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").addClass("hover")});$(".back-to-offer").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").removeClass("hover")});function myScroller(){var scrollPos=$(window).scrollTop();if(scrollPos!=0){$("#desktop-menu-bar").removeClass("open");$("body").addClass("scrolled");if(scrolled==false&&initialLoad==false)scrolled=true}else if(scrollPos===0){scrolled=false;$("#desktop-menu-bar").addClass("open");
$("body").removeClass("scrolled")}}var initialLoad=true;var scrolled=false;$(window).on("scroll",function(){myScroller()});myScroller()};
sagewest.page.Home.prototype.map_initialize=function(){var map;var styles=[{"featureType":"water","elementType":"geometry.fill","stylers":[{"color":"#d3d3d3"}]},{"featureType":"transit","stylers":[{"color":"#808080"},{"visibility":"off"}]},{"featureType":"road.highway","elementType":"geometry.stroke","stylers":[{"visibility":"on"},{"color":"#b3b3b3"}]},{"featureType":"road.highway","elementType":"geometry.fill","stylers":[{"color":"#ffffff"}]},{"featureType":"road.local","elementType":"geometry.fill",
...
mapTypeId:"Styled",scrollwheel:false,zoomControl:true};map=new google.maps.Map(document.getElementById("map"),mapOptions);var styledMapType=new google.maps.StyledMapType(styles,{name:"Styled"});map.mapTypes.set("Styled",styledMapType);var WestPerthLatlng=setMarkerLatLng(-31.947888,115.8364702);var JamesStreetLatlng=setMarkerLatLng(-33.3220933,116.4979821);var WollongongLatlng=setMarkerLatLng(-34.4282346,150.8842032);var AdelaideLatlng=setMarkerLatLng(-34.9256023,138.583259);infobox=new InfoBox({disableAutoPan:false,
maxWidth:225,zIndex:null,boxStyle:{opacity:1,width:"225px"},infoBoxClearance:new google.maps.Size(1,1)});var markersObj={};function createGoogleMarker(markerName,Latlng,icon,title){markersObj[markerName]=new google.maps.Marker({position:Latlng,map:map,title:title,icon:"images/icons/map-pin.png"})}createGoogleMarker("WestPerthMarker",WestPerthLatlng,"westperth","Sage West Perth");createGoogleMarker("JamesStreetMarker",JamesStreetLatlng,"jamesstreet","James Street");createGoogleMarker("WollongongMarker",
WollongongLatlng,"wollongong","Wollongong");createGoogleMarker("AdelaideMarker",AdelaideLatlng,"adelaide","Adelaide");var WestPerthPlaceId="ChIJufd18zGlMioRIFTfNbXwBAU";var JamesStreetPlaceId="EihKYW1lcyBTdCwgTm9ydGhicmlkZ2UgV0EgNjAwMywgQXVzdHJhbGlh";var WollongongPlaceId="ChIJe1YLH6UZE2sRIOcyFmh9AQU";var AdelaidePlaceId="ChIJ56QDo9fOsGoRUz4cTlhwjbM";requestObj={};function createRequestObj(requestObjName,PlaceId){requestObj[requestObjName]={placeId:PlaceId}}createRequestObj("westPerthRequest",WestPerthPlaceId);
createRequestObj("JamesStreetRequest",JamesStreetPlaceId);createRequestObj("WollongongRequest",WollongongPlaceId);createRequestObj("AdelaideRequest",AdelaidePlaceId);function events(Marker,MarkerLatLng,MarkerRequest){google.maps.event.addListener(Marker,"click",function(){infobox.open(map,this);infobox.setContent("<div class='infoBox-text'><div class='address'><div class='address-icon'></div><div class='address-content'><a target='_blank' href='http://maps.google.com/?q=Sage West Perth 1309 Hay Street, West Perth WA 6005, Australia'><h4>Sage West Perth</h4><p>1309 Hay Street, West Perth WA 6005, Australia</p></a></div></div><div class='telephone'><div class='telephone-icon'></div><div class='telephone-content'><a href='#'><p>+61 8 6500 9100</p></a></div></div><div class='mail'><div class='mail-icon'></div><div class='mail-content'><p><a href='#'>reservations.westperth@sage-hotels.com</a></p></div></div><div class='arrow-left'></div></div>");
