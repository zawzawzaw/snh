...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        FP.scrollToAnchorPublic = function(){
            scrollToAnchor();
        };
    ...
    var slimScrollHandler = {
        ...
        scrollable: function(activeSection){
            ...
            */
            // jairus edit!!!!  (removing slides functionality)

            // console.log('activeSection.find(SCROLLABLE_SEL): ');
            // console.log(activeSection.find(SCROLLABLE_SEL));
