      ...
      <div class="container-fluid">
        <div class="col-md-3 col-md-offset-9">
          <div class="reservation-summary-sidebar">
            <div class="reservation-summary-sidebar-title">
              ...
              <div class="reservation-summary">
                ...
                <div class="reservation-summary-content">
                  ...
                  <div id="sticky-sidebar">
                    ...
                    <button type="submit" class="square-cta proceed-to-payment highlight-version hidden-xs hidden-xs">proceed to booking</button>
                  </div>
                </div>
              </div>
            </div>
...
<script id="guest-detail-for-each-room-form" type="text/x-handlebars-template">
  <div class="guest-for-each-room">
    <div class="row">
      <div class="col-md-4">
        <h5 class="room-detail-no">Room Detail {{ no_of_room_booked }}</h5></div>
      <div class="col-md-8">
