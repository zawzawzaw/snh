...
sagewest.page.Hotel.prototype.update_page_layout=function(){sagewest.page.Hotel.superClass_.update_page_layout.call(this);this.window_width=this.window.width();this.window_height=this.window.height();if(this.window_width<=1280&&manic.IS_ACTUAL_MOBILE==false||manic.IS_ACTUAL_MOBILE==true&&manic.IS_TABLET_LANDSCAPE){this.window_width*=1.1111;this.window_height*=1.1111}};
sagewest.page.Hotel.prototype.scroll_to_target=function(str_param,str_param_2,str_param_3){sagewest.page.Hotel.superClass_.scroll_to_target.call(this,str_param)};sagewest.page.Hotel.prototype.on_scroll_to_no_target=function(){};
sagewest.page.Hotel.prototype.others=function(){$("body").addClass("preload-start");$("#hotel-reviews-slider").slick({dots:false,infinite:true,autoplay:true,slidesToShow:1,prevArrow:'<a class="carousel-prev"><span></span></a>',nextArrow:'<a class="carousel-next"><span></span></a>'});$("#hotel-booking-content").slick({slidesToShow:1,responsive:[{breakpoint:4E3,settings:"unslick"},{breakpoint:991,settings:{dots:true,arrows:false,slidesToShow:1,slidesToScroll:1}}]});this.map_initialize();$(".tnc").on("click",
function(e){e.preventDefault();$(this).closest(".flip-container").addClass("hover")});$(".back-to-offer").on("click",function(e){e.preventDefault();$(this).closest(".flip-container").removeClass("hover")});function myScroller(){var scrollPos=$(window).scrollTop();var position;if(manic.IS_MOBILE)if(scrollPos!=0){$("#desktop-menu-bar").removeClass("open");$("body").addClass("scrolled");if(scrolled==false&&initialLoad==false)scrolled=true}else{if(scrollPos===0){scrolled=false;$("#desktop-menu-bar").addClass("open");
$("body").removeClass("scrolled")}}else{var position=467;if(scrollPos>=position){$("#desktop-menu-bar").removeClass("open");$("body").addClass("scrolled");if(scrolled==false&&initialLoad==false)scrolled=true}else if(scrollPos<=position){scrolled=false;$("#desktop-menu-bar").addClass("open");$("body").removeClass("scrolled")}}}var initialLoad=true;var scrolled=false;$(window).on("scroll",function(){myScroller()});myScroller()};
sagewest.page.Hotel.prototype.map_initialize=function(){var map;var styles=[{"featureType":"administrative","elementType":"labels.text.fill","stylers":[{"color":"#6195a0"}]},{"featureType":"landscape","elementType":"all","stylers":[{"color":"#f2f2f2"}]},{"featureType":"landscape","elementType":"geometry.fill","stylers":[{"color":"#ffffff"}]},{"featureType":"poi","elementType":"all","stylers":[{"visibility":"off"}]},{"featureType":"poi.park","elementType":"geometry.fill","stylers":[{"color":"#e6f3d6"},
...
lng){return new google.maps.LatLng(lat,lng)}var AusLatLng=setMarkerLatLng(-31.946899,115.8524116);var mapOptions={mapTypeControlOptions:{mapTypeIds:["Styled"]},zoom:15,center:AusLatLng,disableDefaultUI:true,mapTypeId:"Styled",scrollwheel:false,zoomControl:true};map=new google.maps.Map(document.getElementById("hotel-attraction-map"),mapOptions);var styledMapType=new google.maps.StyledMapType(styles,{name:"Styled"});map.mapTypes.set("Styled",styledMapType);var WestPerthLatlng=setMarkerLatLng(-31.9494288,
115.8362825);var OrdStLatlng=setMarkerLatLng(-31.948616,115.835907);var JamesStLatlng=setMarkerLatLng(-31.946899,115.8524116);var FielderStLatlng=setMarkerLatLng(-31.9509356,115.8708259);var SterlingStLatlng=setMarkerLatLng(-31.9468795,115.8635481);infobox=new InfoBox({disableAutoPan:false,maxWidth:225,zIndex:null,boxStyle:{opacity:1,width:"225px"},infoBoxClearance:new google.maps.Size(1,1)});var markersObj={};function createGoogleMarker(markerName,Latlng,icon,title){markersObj[markerName]=new google.maps.Marker({position:Latlng,
map:map,title:title,icon:"images/icons/map-pin-grey.png"})}createGoogleMarker("WestPerthMarker",WestPerthLatlng,"westperth","Sage West Perth");createGoogleMarker("OrdMarker",OrdStLatlng,"ordst","Ord Street");createGoogleMarker("JamesStreetMarker",JamesStLatlng,"jamesst","James Street");createGoogleMarker("FielderStreetMarker",FielderStLatlng,"fielder","Fielder Street");createGoogleMarker("SterlingStreetMarker",SterlingStLatlng,"sterling","Sterling Street");var WestPerthPlaceId="ChIJufd18zGlMioRIFTfNbXwBAU";
var OrdStPlaceId="EihKYW1lcyBTdCwgTm9ydGhicmlkZ2UgV0EgNjAwMywgQXVzdHJhbGlh";var JamesStPlaceId="ChIJe1YLH6UZE2sRIOcyFmh9AQU";var FielderStPlaceId="ChIJ56QDo9fOsGoRUz4cTlhwjbM";var SterlingStPlaceId="EiVTdGlybGluZyBTdCwgUGVydGggV0EgNjAwMCwgQXVzdHJhbGlh";requestObj={};function createRequestObj(requestObjName,PlaceId){requestObj[requestObjName]={placeId:PlaceId}}createRequestObj("westPerthRequest",WestPerthPlaceId);createRequestObj("OrdStRequest",OrdStPlaceId);createRequestObj("JamesStRequest",JamesStPlaceId);
createRequestObj("FielderStRequest",FielderStPlaceId);createRequestObj("SterlingStRequest",SterlingStPlaceId);function events(Marker,MarkerLatLng,MarkerRequest){google.maps.event.addListener(Marker,"click",function(){infobox.open(map,this);infobox.setContent("<div class='infoBox-text'><div class='address'><div class='address-content'><a target='_blank' href='http://maps.google.com/?q=Sage West Perth 1309 Hay Street, West Perth WA 6005, Australia'><h4>Sage West Perth</h4><p>1309 Hay Street, West Perth WA 6005, Australia</p></a></div></div><div class='arrow-left'></div></div>");
infobox.setOptions({"pixelOffset":new google.maps.Size(45,-95)});map.panTo(MarkerLatLng)});google.maps.event.addListener(Marker,"mouseover",function(){Marker.setIcon("images/icons/map-pin-hover.png")});google.maps.event.addListener(Marker,"mouseout",function(){Marker.setIcon("images/icons/map-pin-grey.png")});google.maps.event.addListener(map,"click",function(event){infobox.close()})}events(markersObj["WestPerthMarker"],WestPerthLatlng,requestObj["westPerth"]);events(markersObj["OrdMarker"],OrdStLatlng,
requestObj["OrdStRequest"]);events(markersObj["JamesStreetMarker"],JamesStLatlng,requestObj["JamesStRequest"]);events(markersObj["FielderStreetMarker"],FielderStLatlng,requestObj["FielderStRequest"]);events(markersObj["SterlingStreetMarker"],SterlingStLatlng,requestObj["SterlingStRequest"]);google.maps.event.addDomListener(window,"resize",function(){var center=map.getCenter();google.maps.event.trigger(map,"resize");map.setCenter(center)})};goog.exportSymbol("sagewest.page.Hotel",sagewest.page.Hotel);
