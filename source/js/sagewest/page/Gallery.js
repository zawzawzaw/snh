...
sagewest.page.Gallery.prototype.create_experience_slider = function(){
...
sagewest.page.Gallery.prototype.create_contact_map = function(){
...
sagewest.page.Gallery.prototype.create_instagram = function(){
...
sagewest.page.Gallery.prototype.on_before_instafeed_create_html = function(){
  $('#home-instagram-item-container').empty();
};


sagewest.page.Gallery.prototype.on_after_instafeed_create_html = function(){
...
sagewest.page.Gallery.prototype.scroll_to_target = function(str_param, str_param_2, str_param_3) {
  sagewest.page.Gallery.superClass_.scroll_to_target.call(this, str_param);
...
sagewest.page.Gallery.prototype.others = function(){  
...
sagewest.page.Gallery.prototype.map_initialize = function() {
